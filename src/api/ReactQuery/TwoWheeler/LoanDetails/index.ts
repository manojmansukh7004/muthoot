...
export const useGetDeliveryLetter = (payload: getDeliveryLetterRequest) => {
  const mutation = useMutation<getDeliveryLetterResponse>(
    ['Vehical', payload],
    async () => {
      const response = await Vehical.GetDeliveryLetter(payload);
      if (response.error) {
        useShowFlashMessage('warning', response.message);
      }
      return response.data;
...
export const useGetRSAAmountYear = (payload) => {
  const mutation = useMutation<GetRSAAmountYearResponse>(
    ['Vehical', payload],
    async () => {
      const response = await Vehical.GetRSAAmountYear(payload);
      if (response.error) {
        useShowFlashMessage('warning', response.message);
      }
      return response.data;
