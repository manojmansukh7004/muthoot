...
const GoDigitInsurance = () => {
  ...
  const [
    ...
    `?applicantId=${applicantId}&language=${'English'}&languageLabel=${'English'}`,
  );
console.log("selectedItem?.labeljjj",selectedItem?.dropdownValue);
  ...
  const renderItem = ({item}) => {
    ...
    return (
      <TouchableOpacity
        ...
        onPress={() => {
          handleSelectItem(item), setSelectedValue(item.value);
        }}>
        {/* Radio button */}
        <View style={styles.radioButtonContainer}>
          ...
          <View
            style={[
              ...
              isSelected && styles.radioButtonSelectedOuter,
            ]}>
  ...
  return (
    ...
    <View>
      ...
      <Text style={styles.heading}>Go Digit Life Insurance</Text>

      <Text style={styles.MessageText}>
        We are pleased to inform you that your Go Digit Life Insurance is now
        available for download. Below, you can find the sample Go Digit Life
        Insurance:
      </Text>
        ...
        <>
            ...
            !isResendOTPPressed && (
              <>
                ...
                <Button
                  text="Generate OTP"
                  active={
                    isConsent && GetSanctionLetterData?.unsigned_sanction_letter
                      ? true
                      : false
                  }
                  marginVertical={10}
          ...
          {!GetSanctionLetterData?.signed_sanction_letter && (
            <View style={{alignItems: 'center', marginVertical: '5%'}}>
              <Text style={[styles.OTPText, {}]}>Didn't received OTP ?</Text>
      ...
      {GetSanctionLetterData?.signed_sanction_letter != null &&
      GetSanctionLetterData?.signed_sanction_letter != '' ? (
        <>
          <View
            style={{
...
export default GoDigitInsurance;
