...
type KFSNavigationProp = StackNavigationProp<
  ...
  'KFS'
>;
type KFSRouteProp = RouteProp<RootStackParamList, 'KFS'>;
...
console.log("jjjjjjjj",isConsent && GetKFSData?.isNextEnable);
  ...
  return (
    ...
    >
      ...
      {/* <View style={{ height: 350, backgroundColor: 'transparent', borderRadius: 15 }}>
        <Pdf
          trustAllCerts={false}
