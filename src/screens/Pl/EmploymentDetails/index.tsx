...
import { AddEmploymentDetailsRequest } from 'api/ReactQuery/PL/Employment/types';
import { useGetBRE3Status } from 'api/ReactQuery/PL/RuleEngineApi';
import { GetBRE3StatusRequest } from 'api/ReactQuery/PL/RuleEngineApi/types';
...
const EmploymentDetails: FC<EmploymentDetailsScreenProps> = ({
  ...
  useEffect(() => {
    ...
    isGuarantor && GetEmploymentDetailsGuarantor.mutateAsync();
