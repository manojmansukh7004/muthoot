...
} from 'api/ReactQuery/PL/PennyDrop';
import {
  VerifyBankAccountRequest,
  GetBankAccountDetailsRequest,
} from 'api/ReactQuery/PL/PennyDrop/types';
import {
...
const BankDetails: FC<BankDetailsScreenProps> = ({ navigation, route }) => {
  ...
  useEffect(() => {
    if (useViewStatus) {
      console.log("useViewStatus", useViewStatus?.isReEditbankDetails);
  ...
  // console.log("GetBankAccountDetailsData",GetBankAccountDetailsData, isViewOnly)

  return (
    <WaveBackground
      loading={[VerifyBankAccountIsLoading, UploadDocumentsIsLoading, UploadAccStatementIsLoading, GetBankAccountDetailsIsLoading]}
      title={'Bank Details'}>
      <Modal
