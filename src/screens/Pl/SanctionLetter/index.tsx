...
} from 'api/ReactQuery/PL/SanctionLetter';
import { VerifyOTPSanctionLetterRequest } from 'api/ReactQuery/PL/SanctionLetter/types';
  ...
  return (
    <WaveBackground
      ...
      <View
        ...
        {
          (!GetSanctionLetterData?.unsigned_sanction_letter || GetSanctionLetterData?.unsigned_sanction_letter == null) &&
          <Button
            text={'Proceed'}
