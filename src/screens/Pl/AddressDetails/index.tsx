...
import {
  ...
  useGetDedupeDetails
} from 'api/ReactQuery/PL/Address';
import {
  AddCurrentAddressRequest,
  AddPermanentAddressRequest,
  GetDedupeDetailsRequest
} from 'api/ReactQuery/PL/Address/types';
import { useGetAadharDetails } from 'api/ReactQuery/PL/OCR';
import { useGetPincode } from 'api/ReactQuery/PL/Lead';
import { useGetCriff } from 'api/ReactQuery/PL/BureauApi';
...
const AddressDetails: FC<AddressDetailsScreenProps> = ({ navigation, route }) => {
  ...
  useEffect(() => {
    if (GetDedupeDetailsData) {
      console.log("GetDedupeDetailsData", GetDedupeDetailsData);
  ...
  useEffect(() => {
    if (AddCurrentAddressData) {
      ...
      if (residenceType === 'Family-Owned' || residenceType === 'Self-Owned') {
        ...
        // need to change both liee comment
