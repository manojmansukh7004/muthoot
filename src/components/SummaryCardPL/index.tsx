...
import { GetCKYCStatusResponse } from 'api/ReactQuery/PL/CKYC/types';
import { LoanSummaryNavigationProp } from 'screens/Pl/LoanSummary';
import { GetCriffResponse } from 'api/ReactQuery/PL/BureauApi/types';
import styles from './styles';
import { ScreenNames } from 'config/Types';
import { salesRejectedRequest, salesReEditRequest } from 'api/ReactQuery/PL/Lead/types';
import { useSalesReject, useSalesReEdit, useViewStatus } from 'api/ReactQuery/PL/Lead';
...
const SummaryCardPL: FC<SummaryCardType> = ({
  section,
  title,
  CKYCData,
  navigation,
  ...
  // console.log("mjjjjjjjrrr==js", JSON.stringify(section, null, 4));
